    ...
    return (
        <>
            <div className="home__data">
                <h1 className="home__title">Siddhesh Jadhav
                    <svg
                        width="36"
                        height="36"
                        viewBox="0 0 48 48"
                ...
                <p className="home__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut, maxime sapiente et placeat, eius suscipit dolorum deleniti unde rem nobis fugiat ipsum animi quisquam ullam veritatis error? Voluptatem, id animi?</p>
